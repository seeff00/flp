 ...
 */
final class Version20231119051341 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE image ADD CONSTRAINT FK_C53D045F8632E6C3 FOREIGN KEY (products_images_id) REFERENCES products_images (id)');
        ...
        $this->addSql('ALTER TABLE product ADD CONSTRAINT FK_D34A04AD8632E6C3 FOREIGN KEY (products_images_id) REFERENCES products_images (id)');
        ...
        $this->addSql('DROP INDEX UNIQ_662C35404584665A ON products_images');
        $this->addSql('DROP INDEX UNIQ_662C35403DA5256D ON products_images');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE products_images ADD CONSTRAINT FK_662C35404584665A FOREIGN KEY (product_id) REFERENCES product (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_662C35404584665A ON products_images (product_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_662C35403DA5256D ON products_images (image_id)');
    }
}
