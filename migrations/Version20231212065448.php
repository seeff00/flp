 ...
 */
final class Version20231212065448 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product_category ADD external_link VARCHAR(255) DEFAULT NULL, CHANGE description description VARCHAR(1000) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product_category DROP external_link, CHANGE description description VARCHAR(1000) DEFAULT NULL');
    }
}
